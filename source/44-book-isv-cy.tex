...
Елементи \(S_i\) Галоисовој групы \(\mathfrak G\) од \(\mathsf Z\) сут автоморфизмы, кторе оставјајут \(\mathsf P\) неподвижным, од \(\mathsf Z\). Чинимо јих автоморфизмами од \(\mathfrak Z_{\mathsf Z}\) установјеньем
\[
